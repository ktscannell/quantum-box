...
var WaveFunction = /*#__PURE__*/function () {
  ...
  _createClass(WaveFunction, [{
    ...
    value: function renderMathFunction(time, n) {
      var t = time / 1000;
      var first = true;
      this.ctx.beginPath();
      ...
      for (var x = _util__WEBPACK_IMPORTED_MODULE_0__["default"].minimumX(); x <= _util__WEBPACK_IMPORTED_MODULE_0__["default"].maximumX(); x += _util__WEBPACK_IMPORTED_MODULE_0__["default"].xStep()) {
        ...
        var f = _util__WEBPACK_IMPORTED_MODULE_0__["default"].maximumY() * Math.sin(n * Math.PI * x / _util__WEBPACK_IMPORTED_MODULE_0__["default"].maximumX()); // add time dependency
